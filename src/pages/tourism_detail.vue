<template>
	<div id="activity_detail" v-if="detail.detail">
	    <div class="cover">
	         <div>
	    ...
	    <div  class="title">
	        <label v-html="detail.detail.content"></label>
	        <div class="sprice">
	           报名费：<font>￥{{'8'+detail.detail.price+'0'}}</font>起/人
	        </div>
	        <div class="clear"></div>
	    </div>
	    <div class="introduce">
	        <div class="detail">
	            <label>活动介绍:</label>
	            <div class="clear"></div>
	            <div class="con">{{detail.detail.inc}}</div>
	        </div>
	    </div>
	</div>
</template>
...
<style scoped>
	...
	#activity_detail .cover img.big_img{
		width: 100%;
		height: 4.298245rem;
		display: block;
	}
