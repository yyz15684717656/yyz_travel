<template>
	<div>
		<div id="news_detail">
		    <div class="cover">
				 <div>
				<img :src="detail.detail.icon" alt="" class="big_img">
		        <router-link title="" class="return" to='/specialityMall'><span><img src="../../public/images/history1.png" alt=""></span></router-link>
		         </div>
				<div  class="title">
		            <p>{{detail.tourContent}}</p>
		            <span>2016/12/11</span>
		            <div class="clear"></div>
		        </div>
		        <div class="read">
		            <img class="eye " src="/images/read.png">
		            <span>{{detail.price}}+</span>
		        </div>
		    </div>
		    <div class="fill">
		        <div class="con">
		            <p>{{detail.detail.inc}}</p>
		            <img src="images/head.jpg">
		            <p>它位于洛阳市城南十三公里，这里是香山和龙门山两山对峙，伊河水从中穿流而过，远望犹如一座天然的门阙，所以古称“伊阙”。</p>
		        </div>
		    </div>
		</div>
...
<style scoped>
	...
	#news_detail .cover .title{
	    ...
	    left:0;
		width:100%;
		padding-left: 0.087719rem;
		padding-bottom: 0.087719rem;
		box-sizing: border-box;
